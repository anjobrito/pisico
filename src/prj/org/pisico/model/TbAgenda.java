...
@NamedQueries({
    ...
    @NamedQuery(name = "TbAgenda.findByDate", query = "SELECT t FROM TbAgenda t WHERE t.idAgenda = :idAgenda"),
    ...
    @NamedQuery(name = "TbAgenda.findByAgendamento", query = "SELECT t FROM TbAgenda t WHERE (t.dtAgendamento between :dtAgendamento1 and :dtAgendamento2) and t.strStatus='A' "),    
...
public class TbAgenda implements Serializable {
    ...
    public void setDtAgendamento(java.util.Date dtAgendamento) {
    ...
    public java.util.Date getDtCancelamento() {
        return dtCancelamento;
    }

    public void setDtCancelamento(java.util.Date  dtCancelamento) {
    ...
    public java.util.Date getDtAtendimento() {
        return dtAtendimento;
    }

    public void setDtAtendimento(java.util.Date dtAtendimento) {
    ...
    public String toString() {
        return new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(this.dtAgendamento);
    }
